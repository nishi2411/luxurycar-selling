                ...
                <div class="container text-center my-5 pt-5 pb-4">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            ...
                            <li class="breadcrumb-item text-white  active" aria-current="page">Bike Detail Page</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <?php //while($row = mysqli_fetch_array($res)){  ?>
                                        ...
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            ...
                                            <a href="bike_detailpage.php?vehicle=<?php echo $row['vehicle_id']; ?>" class="btn btn-primary" style="width:200px">View Bike Detail</a>
                                        </div>
                                    </div>
                                </div>
                                <?php } ?>
