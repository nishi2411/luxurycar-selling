...
include("session_customer.php");
    ...
    if(isset($_REQUEST['vid']))
    {
        ...
        header("location:car_detailpage.php?vehicle=$vehicleid");
    }
            ...
            <div class="card-body">
                ...
                <div class="col-12 col-sm-6">
                    ...
                    <div class="btn-group btn-group-toggle d-flex" data-toggle="buttons">
                       ...
                       <div class="col-6 my-1">
                        <h6> <i class="nav-icon fas fa-tachometer-alt" style='font-size:20px;color:#3783c6'></i> <?php echo $row['total_km'];  ?> </h6>
                       </div>  
                    </div>
                    <div class="btn-group btn-group-toggle d-flex" data-toggle="buttons">
                       <div class="col-6 my-1">
                     ...
                     $vid = $_GET['vehicle'];
						   ...
						   {?>
                                 <div class="btn btn-danger btn-lg btn-flat"> 
                                    <a href="car_detailpage.php?vid=<?php echo $row['vehicle_id']; ?>" class="text-white" onClick="return confirm('Are You Sure Request For This Vehicle?')">
                    ...
                    <div class="row mt-4 border d-flex">
