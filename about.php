...
<body>
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6">
                        ...
                        <p class="mb-4">
                        Before we get ahead of ourselves, we want to welcome you to Harman Motors. While nothing can replace an on-the-lot experience, we appreciate you taking the time today to visit our website. Our goal is to give you an interactive tour of our used car inventory, as well as allow you to conveniently get the best option or apply for financing.
                        </p>
                        <p class="mb-4"> The search for a used luxury car is filled with high expectations. Undoubtedly, that has a lot to do with the vehicles you are considering, but at Harman Motors, we think you should also have pretty high expectations for your dealership.</p>
    ...
    <script src="lib/owlcarousel/owl.ca';rousel.min.js"></script>
